 ...
 * AysRoomRegistry
 *
 * Simple registry for mapping room type names to room classes.
 * Designed for global-script loading (non-module) environments.
 */
...
const AysRoomRegistry = (function() {
  ...
  function get(roomType) {
    ...
    return registry[roomType] || registry[String(roomType).toLowerCase()] || null;
  }
...
if (typeof Garage !== 'undefined') AysRoomRegistry.register('Garage', Garage);

// Export for global usage
if (typeof window !== 'undefined') {
  window.AysRoomRegistry = AysRoomRegistry;
}
