/**
 * AysListItemCheckbox Component
 * 
 * Renders an individual checkbox list item with metadata tags
 * Part of the Ays component family - describes a list item with checkbox toggle
 * 
...
class AysListItemCheckbox {
  ...
  bind() {
    if (!this.checkboxElement) {
      console.warn('AysListItemCheckbox: Cannot bind - element not rendered yet');
      return;
    }
