...
- [ ] Polish furniture
- [ ] Dust baseboards, pictures, lampshades, knick-knacks, windowsills, furniture, light fixtures and other decor.
- [ ] Garbage removal
...
# END-OF-TENANCY (EMPTY)

Built-in fixtures only. No movable items or housework-style tasks.
...
- [ ] Clean microwave oven
- [ ] All cupboard and appliance surfaces cleaned
- [ ] Dust baseboards, windowsills, light fixtures and trims.
- [ ] Sweep and mop or vacuum floors
...
## FRONT STAIRWAY
- [ ] Dust baseboards, bannisters, light fixtures and trims.
- [ ] Floors vacuumed or mopped
...
# SATISFACTION:
We aim to please. If for any reason, at any time you are not completely please call us immediately at

# PAYMENT:
Paying with a credit/debit card, Cash are also fine and can be left on the kitchen counter
